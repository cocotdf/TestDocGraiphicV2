...
<p align="center"><img alt="input_forward_1d_by_index.png" src="assets/input_forward_1d_by_index.png" width="288"/></p>

<h3>Input parameters</h3>

<p><img alt="Array Single.Png" src="assets/array-single.png" width="32"/><strong>1D Input Data : <em>array</em>, </strong>1D array of data with any type : integers (signed/unsigned), floats, doubles, booleans, or strings.</p>

<table>
  <tbody>
    <tr>
      <td valign="top" width="70%"><p><img alt="Cluster Array In.Png" src="assets/cluster-array-in.png" width="32"/><strong>Data in : <em>array, </em></strong>is an array of clusters, where each cluster represents a single model input. Each cluster contains metadata and raw data required to describe and pass an input tensor to the model.</p>
...
<p>​</p></td>
      <td valign="top" width="30%"><p align="center"><img src="assets/param_loss_input_by_index.png" alt="param_loss_input_by_index" width="220" /></p></td>
    </tr>
  </tbody>
</table>

<p><img alt="Integer 32.Png" src="assets/integer-32.png" width="32"/><strong>input order : <em>integer</em>,</strong> defines the position of the input within the data array. It corresponds to the index assigned to the input when it is created (via the</p>
...
<table>
  <tbody>
    <tr>
      <td valign="top" width="70%"><p><img alt="Cluster Array Out.Png" src="assets/cluster-array-out.png" width="32"/><strong>Data out : <em>array, </em></strong>is an array of clusters, where each cluster represents a single model input. Each cluster contains metadata and raw data required to describe and pass an input tensor to the model.</p>

<table>
  <tbody>
    <tr>
      <td width="64" valign="top"><img alt="output_unsigned_16.png" src="assets/output_unsigned_16.png" width="42"/></td>
      <td valign="top"><strong>y_true_order : <em>integer</em>,</strong> defines the position of the input within the data array. It corresponds to the index assigned to the input when it is created (via the <i>index</i> parameter).</td>
    </tr>
    <tr>
...
<p>​</p></td>
      <td valign="top" width="30%"><p align="center"><img alt="param_loss_output_by_index" src="assets/param_loss_output_by_index.png" width="220"/></p></td>
    </tr>
  </tbody>
</table>
