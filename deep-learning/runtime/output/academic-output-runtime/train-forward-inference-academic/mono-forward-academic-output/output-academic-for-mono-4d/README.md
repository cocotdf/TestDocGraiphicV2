...
<p>Retrieve Mono 4D Output Data (Bool, Int/UInt, Float, or String) (Academic Training Session). Type : <em><strong>polymorphic</strong><strong>.</strong></em></p>

<p align="center"><img src="assets/output_academic_mono_4d.png" alt="output_academic_mono_4d" width="260" /></p>
