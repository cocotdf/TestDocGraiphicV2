...
<p>Execute inference forward with Mono 6D Float Input Data (Academic Training Session).</p>

<p align="center"><img alt="exec_academic_inference_mono_6d" src="assets/exec_academic_inference_mono_6d.png" width="220"/></p>
