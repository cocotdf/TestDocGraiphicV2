...
<p align="center"><img alt="function" src="assets/function.png" width="220"/></p>

<p>In this section you’ll find a list of function available.</p>

|  | **ICONS** | **RESUME** |
| --- | --- | --- |
| [Build Kernel](../filters/build-kernel/README.md) | ![Build_Kernel.Png](assets/build_kernel.png) | Constructs a convolution matrix by converting a string. |
| [Canny Edge Detection](../filters/canny-edge-detection/README.md) | ![Canny_Edge_Detection.Png](assets/canny_edge_detection.png) | Uses a specialized edge detection method to accurately estimate the location of edges even under conditions of poor signal-to-noise ratios. |
| [Convolute](../filters/convolute/README.md) | ![Convolute.Png](assets/convolute.png) | Filters an image using a linear filter. |
| [Edge Detection](../filters/edge-detection/README.md) | ![Edge_Detection_Image.Png](assets/edge_detection_image.png) | Extracts the contours (detects edges) in gray-level values. |
| [Gaussian Blur](../filters/gaussian-blur/README.md) | ![Gaussian_Blur.Png](assets/gaussian_blur.png) | Blurs an image using a Gaussian filter |
| [Get Kernel](../filters/get-kernel/README.md) | ![Get_Kernel.Png](assets/get_kernel.png) | Reads a predefined kernel. |
| [Fill Hole](../form/fill-hole/README.md) | ![Fill_Hole.Png](assets/fill_hole.png) | Fills the holes found in a particle. |
| [Morphology](../form/morphology/README.md) | ![Morphology.Png](assets/morphology.png) | Performs primary morphological transformations. |
| [Particle Filter](../form/particle-filter/README.md) | ![Particle_Filter.Png](assets/particle_filter.png) | Filters (keeps or removes) each particle in an image according to its measurements. |
| [Reject Border](../form/reject-border/README.md) | ![Reject_Border.Png](assets/reject_border.png) | Eliminates particles that touch the border of an image. |
| [Remove Particle](../form/remove-particle/README.md) | ![Remove_Particle.Png](assets/remove_particle.png) | Eliminates or keeps particles resistant to a specified number of 3 x 3 erosions. |
| [Histograph](../inspection/histograph/README.md) | ![Histograph.Png](assets/histograph.png) | Calculates the histogram from an image. |
| [Histogram](../inspection/histogram/README.md) | ![Histogram.Png](assets/histogram.png) | Calculates the histogram of an image. |
| [Line Profile](../inspection/line-profile/README.md) | ![Line_Profile.Png](assets/line_profile.png) | Calculates the profile of a line of pixels. |
| [Particle Analysis](../inspection/particle-analysis/README.md) | ![Particle_Analysis.Png](assets/particle_analysis.png) | Returns the number of particles detected in a binary image and a 2D array of requested measurements about the particle. |
| [Particle Analysis Report](../inspection/particle-analysis-report/README.md) | ![Particle_Analysis_Report.Png](assets/particle_analysis_report.png) | Returns the number of particles detected in a binary image and an array of reports containing the most commonly used particle measurements. |
...
| [Noise](../treatment/noise/README.md) | ![Noise.Png](assets/noise.png) | Fills the matrix dst with normally distributed random numbers with the specified mean vector and the standard deviation matrix. The generated random numbers are clipped to fit the value range of the output array data type. |
| [Normalize](../treatment/normalize/README.md) | ![Normalize.Png](assets/normalize.png) | Normalizes the norm or value range of an array. |
| [Perspective Transform](../treatment/perspective-transform/README.md) | ![Perspective_Transform.Png](assets/perspective_transform.png) | Calculates a perspective transform from four pairs of the corresponding points. |
| [Saturation](../treatment/saturation/README.md) | ![Saturation.Png](assets/saturation.png) | Adjust the saturation in the image.​ |
| [Threshold](../treatment/threshold/README.md) | ![Threshold.Png](assets/threshold.png) | Applies a threshold to an image. |
| [User Lookup](../treatment/user-lookup/README.md) | ![User_Lookup.Png](assets/user_lookup.png) | Performs a user-specified lookup-table transformation by remapping the pixel values in an image. |
| [Value](../treatment/value/README.md) | ![Value.Png](assets/value.png) | Adjust the value in the image. |
