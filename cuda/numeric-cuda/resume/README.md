...
<table>
  <tbody>
    <tr>
      <td valign="top" width="50%"><p align="center"><img src="assets/folder_numeric.png" alt="folder_numeric" width="260" /></p></td>
      <td valign="top" width="50%"><p align="center"><img src="assets/numeric_menu.png" alt="numeric_menu" width="260" /></p></td>
    </tr>
  </tbody>
</table>

<p>In this section you’ll find a list of all numeric fonctionalities.</p>

|  | **ICONS** | **DESCRIPTION** |
| --- | --- | --- |
| [Add](../add/README.md) | ![Add.Png](assets/add.png) | Computes the sum of the inputs. |
...
| [Multiply Array Element](../multiply-array-element/README.md) | ![Multiply_Array_Element.Png](assets/multiply_array_element.png) | Returns the product of all the elements in input array. |
| [Absolute](../absolute-2/README.md) | ![Absolute.Png](assets/absolute.png) | Returns the absolute value of the input. |
...
| [Reciprocal](../reciprocal/README.md) | ![Reciprocal.Png](assets/reciprocal.png) | Divides 1 by the input value. |
| [Sign](../sign/README.md) | ![Sign.Png](assets/sign.png) | Returns the sign of input. |
